...
//        Copy copy = new Copy();
//        copy.setId(copyId);
//        o.setCopies(Collections.singletonList(copy));
////        Copy copy1 = new Copy();
////        copy1.setId(copyId1);
////        o.setCopyId(copy1);
//
...
//        Assertions.assertThat(foundClient.getClientId()).isEqualTo(o.getClient());
//        Assertions.assertThat(foundCopy.getId()).isEqualTo(o.getCopies().get(0).getId());
